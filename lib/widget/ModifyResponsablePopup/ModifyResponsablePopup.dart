...
class ModifyResponsablePopup extends StatefulWidget {
  const ModifyResponsablePopup({Key? key}) : super(key: key);

  @override
  _ModifyResponsablePopupState createState() => _ModifyResponsablePopupState();
}

class _ModifyResponsablePopupState extends State<ModifyResponsablePopup> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text('Modifier un responsable'),
